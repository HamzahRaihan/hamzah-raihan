...
function showToolsCard(tools) {
  return `
  <div class="card">
    <img src="${tools.src}" alt="" width="40" height="40" />
    <div>
...
console.log('🚀 ~ file: script.js:478 ~ projectCardContainer:', projectCardContainer);

function showProjectsCard(prj) {
  return `
  <div class="card-project">
    <img src="${prj.image}" alt="icon" />
    <div class="card-body">
      ...
      <div class="card-footer">
        <img src="./svg/icons8-css.svg" alt="icon" />
        <img src="./svg/icons8-javascript.svg" alt="icon" />
        <img src="./svg/icons8-html-5.svg" alt="icon" />
      </div>
    </div>
  </div>
  `;
